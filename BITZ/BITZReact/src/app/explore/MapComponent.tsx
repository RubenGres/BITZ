...
// This component ensures the map resizes correctly
function MapResizer() {
  const map = useMap();
...
const MapComponent: React.FC<MapComponentProps> = ({ speciesData, questId, mapCenter }) => {
  return (
                ...
                <Popup>
                  <div className="w-56">
                    ...
                    {species.image_name ? (
                      <div className="mb-2">
                        <img
                          src={`${API_URL}/explore/images/${questId}/${species.image_name}`}
